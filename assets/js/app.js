...
// Upload image 
document.addEventListener('DOMContentLoaded', function () {
  document.getElementById('floorUploadBox').addEventListener('click', function () {
    document.getElementById('floorInput').click();
  });

  document.getElementById('photoUploadBox').addEventListener('click', function () {
